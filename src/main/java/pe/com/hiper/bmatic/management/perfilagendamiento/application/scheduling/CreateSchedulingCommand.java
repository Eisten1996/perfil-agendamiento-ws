...
public class CreateSchedulingCommand {
    ...
    public CreateSchedulingCommand(Integer id, String branchId, Integer minDays, Integer maxDays, Integer toleranceTime,
            String services, Integer multipleBookings, Integer confirmEmail, Integer confirmTime,
            String unidConfirmTime) {
        this.id = id;
