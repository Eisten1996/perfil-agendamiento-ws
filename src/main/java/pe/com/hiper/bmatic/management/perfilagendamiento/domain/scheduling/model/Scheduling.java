...
public class Scheduling {
    ...
    public Scheduling(Integer id, String branchId, String branchName, Integer minDays, Integer maxDays,
            Integer toleranceTime, String services, Integer multipleBookings, Integer confirmEmail, Integer confirmTime,
            String unidConfirmTime, String typeAttention) {
        this.id = id;
    ...
    public static class SchedulingBuilder {
        ...
        public Scheduling build() {
            return new Scheduling(id, branchId, branchName, minDays, maxDays, toleranceTime, services, multipleBookings,
                    confirmEmail, confirmTime, unidConfirmTime, typeAttention);
        }
    }
}
