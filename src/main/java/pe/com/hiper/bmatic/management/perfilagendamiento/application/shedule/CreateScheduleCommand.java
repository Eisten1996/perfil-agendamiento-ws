...
public class CreateScheduleCommand {
    ...
    public CreateScheduleCommand(int id, Integer schedulingId, String counterTypeId, String counterId,
            String bookingType, String startHour, String endHour, int day, String date, int addDating) {
        this.id = id;
    ...
    public static class CreateScheduleCommandBuilder {
        ...
        public CreateScheduleCommand build() {
            return new CreateScheduleCommand(id, schedulingId, counterTypeId, counterId, bookingType, startHour,
                    endHour, day, date, addDating);
        }
